...
func add_card_reward() -> void:
	var card_reward := REWARD_BTN.instantiate() as RewardButton
	card_reward.reward_icon = CARD_ICON
	card_reward.reward_text = CARD_TEXT
	card_reward.pressed.connect(show_card_rewards)
...
func show_card_rewards() -> void:
	...
	card_rewards.card_reward_selected.connect(on_card_reward_taken)
...
func modify_weights(rarity_rolled: Card.Rarity) -> void:
...
func on_card_reward_taken(card: Card) -> void:
